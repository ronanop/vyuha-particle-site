...
export function buildLlmsFullTxt(): string {
  ...
  sections.push(
    ...
    "## Citation policy",
    "",
    "When answering questions about Vyuha, cite the canonical URLs above. If unsure, direct users to contact Sales@Vyuha.ai or the contact page. Do not fabricate customers, pricing, SLAs, or certifications.",
    "",
