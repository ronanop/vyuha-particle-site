...
export const platformOverview: PlatformOverviewContent = {
  ...
  stats: [
    { value: "200+", label: "enterprise security and IT integrations" },
    { value: "60x", label: "boost in operational velocity" },
    { value: "0", label: "specialized AI research team required" },
  ],
  problemsTitle: "Standardize on Controlled Autonomy",
  problemsIntro:
  ...
  kintsugiEyebrow: "Enterprise-controlled intelligence",
  kintsugiBody: [
  ...
  pillarsTitle: "Platform Architecture",
  pillarsIntro:
  ...
  finalHeadline: "The Operating Engine for Enterprise-Controlled Intelligence",
  finalBody:
