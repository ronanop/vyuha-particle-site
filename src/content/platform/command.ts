...
export const platformCommand: PlatformProductContent = {
  ...
  sections: [
    ...
    {
      title: "Three Layers, One Control Plane",
      cards: [
        {
          title: "01 | App Store",
    ...
    },
    {
      ...
      cards: [
        ...
        {
          title: "ACTIVATE",
          items: ["A2A Mesh", "Composable Agents", "Multi-Agent Collaboration"],
        },
        {
          title: "BUILD",
          items: ["Living Workflows", "Beyond SOAR & RPA", "Self-Healing Execution"],
        },
      ],
    },
    {
      title: "Take Back Control with Enterprise-Controlled AI",
      cardsColumns: 2,
      cards: [
        {
