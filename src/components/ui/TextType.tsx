  ...
  useEffect(() => {
    ...
    const executeTypingAnimation = () => {
      if (isDeleting) {
        ...
        if (completedIndexRef.current !== currentTextIndex) {
          completedIndexRef.current = currentTextIndex;
          onCompleteRef.current?.(textArray[currentTextIndex] ?? "", currentTextIndex);
        }
